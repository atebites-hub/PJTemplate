...
- **Agent stack** (Taskboard plugin, ODW verifier, J-Space): `docs/agents/agent_stack.md`. Setup fields: `taskboard_plugin`, `odw_verifier`, `jspace_skill` in `config/setup.toml`.
