...
- When structuring task memories using the `memory-system` skill, use the TCREI framework:
    ...
    - I: Plan for Iteration; add todos and update the task memory to refine code quality after the task is completed.
